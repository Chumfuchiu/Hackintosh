 ...
 *
 * Disassembly of iASLvBfKe9.aml, Thu May  2 11:16:17 2019
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0000E58D (58765)
 *     Revision         0x02
 *     Checksum         0x10
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I"
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I", 0x00000031)
{
    ...
    External (_SB_.PCI0.IGPU.DD1F, UnknownObj)    // Warning: Unknown object
    ...
    External (_SB_.PCI0.IGPU.IUEH, MethodObj)    // Warning: Unknown method, guessing 1 arguments
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xDD7FDC18, 0x02B2)
    ...
    Scope (_SB.PCI0.LPCB)
    {
        OperationRegion (CPSB, SystemMemory, 0xDD5A8D18, 0x10)
